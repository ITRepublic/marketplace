    ...
    <div class="container">
        <div class="row" align-items-center>
            <div class="card col-md-6 offset-md-3">
                ...
                {{ Form::open(array('url' => 'register/store', 'method' => 'POST')) }}
                ...
                <div class="form-group">
                    ...
                    {{ Form::textarea('CompanyAddress', old('CompanyAddress'), array('class' => 'form-control')) }}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {{ Form::textarea('CompanyProfile', old('CompanyProfile'), array('class' => 'form-control')) }}
                </div>
                <div class="form-group">
