...
Route::get('/webadmin', 'AdminPanelController@create');
Route::post('webadmin/login', ['uses' => 'AdminPanelController@store', 'before' => 'csrf']);
Route::get('webadmin/register', 'AdminPanelController@createregister');
Route::post('webadmin/register', ['uses' => 'AdminPanelController@storeregister', 'before' => 'csrf']);
